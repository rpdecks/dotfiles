...
async function activate(context, handleLocal = true) {
    ...
    registerEventListener(context, vscode.window.onDidChangeActiveTextEditor, async () => {
        ...
        const oldFileRegister = (_a = (await register_1.Register.get(undefined, '%'))) === null || _a === void 0 ? void 0 : _a.text;
        ...
        if (relativePath !== oldFileRegister) {
            if (oldFileRegister && oldFileRegister !== '') {
                register_1.Register.putByKey(oldFileRegister, '#', register_1.RegisterMode.CharacterWise, true);
            }
            register_1.Register.putByKey(relativePath, '%', register_1.RegisterMode.CharacterWise, true);
        }
